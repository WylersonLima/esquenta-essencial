...
import {IconError404, IconArrowsDiff, IconLayout2, IconHome2, IconListDetails, IconUserHexagon } from "@tabler/icons-react";
    ...
    return(
        <aside className="w-80 bg-zinc-900 p-6 border-r border-zinc-800" >
            <nav className="flex flex-col gap-2">
               ...
               <MenuItem texto="Cliente vs Servidor" href="/cliente-servidor" icone={IconArrowsDiff} />
